...
sub process_tables
{
    ...
    open FILE, "<$FindBin::Bin/CreateTables.sql";
    ...
    open OUT, ">$FindBin::Bin/DropTables.sql";
    ...
    open OUT, ">$FindBin::Bin/SetSequences.sql";
    print OUT "-- Automatically generated, do not edit.\n";
    print OUT "\\unset ON_ERROR_STOP\n\n";
    ...
    open OUT, ">$FindBin::Bin/CreateFKConstraints.sql";
    print OUT "-- Automatically generated, do not edit.\n";
    ...
    open OUT, ">$FindBin::Bin/DropFKConstraints.sql";
    print OUT "-- Automatically generated, do not edit.\n";
    print OUT "\\unset ON_ERROR_STOP\n\n";
    foreach my $table (@tables) {
        next unless exists $foreign_keys{$table};
    ...
    open OUT, ">$FindBin::Bin/CreatePrimaryKeys.sql";
    print OUT "-- Automatically generated, do not edit.\n";
    print OUT "\\set ON_ERROR_STOP 1\n\n";
    foreach my $table (@tables) {
    ...
    open OUT, ">$FindBin::Bin/DropPrimaryKeys.sql";
    print OUT "-- Automatically generated, do not edit.\n";
    print OUT "\\unset ON_ERROR_STOP\n\n";
    foreach my $table (@tables) {
        next unless exists $primary_keys{$table};
...
sub process_indexes
{
    ...
    open FILE, "<$FindBin::Bin/$infile" or return;
    my $create_indexes_sql = do { local $/; <FILE> };
    close FILE;

    return unless $create_indexes_sql;
...
open FILE, "<$FindBin::Bin/CreateTriggers.sql";
...
open OUT, ">$FindBin::Bin/DropTriggers.sql";
print OUT "-- Automatically generated, do not edit.\n";
print OUT "\\unset ON_ERROR_STOP\n\n";
