...
SELECT _v.register_patch('20110804-versions', ARRAY['20110804-roles'], NULL);
...
SELECT publisher.gid, name, version
FROM bookbrainz_v.branch
...
SELECT person.gid, name, version
FROM bookbrainz_v.branch
